...
const administration = {
  ...
  components: {
    default: () => __vitePreload(() => import(
      ...
      './AdministrationBoard-B3Jr7A52.js'
    ),true              ?[]:void 0)
  }
};
...
const folder = {
  ...
  components: {
    default: () => __vitePreload(() => import(
      ...
      './AccountBoard-vgN5KmmK.js'
    ),true              ?[]:void 0)
  }
};

const app = createApp(defineAsyncComponent(() => __vitePreload(() => import('./App-tZNabPca.js'),true              ?[]:void 0)));
app.use(router);
